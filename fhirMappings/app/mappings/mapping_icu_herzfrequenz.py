...
def map_ressource(input_json):
    ...
    observationId = f'IU-PULS-{sha224(input_json["measurement_id"].encode("utf-8")).hexdigest()}'

    observationMeta = {
        'profile': [
            'https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-monitoring-und-vitaldaten|4.0.1',
            'https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/herzfrequenz|2025.0.2'
        ]
    }
    ...
    code = {
        'coding': [coding_snomed, coding_loinc, code_ieee]
    }
